...
public class UsuarioController {
    ...
    public String listarUsuario(Model model){
        model.addAttribute("usuarios", usuarioService.listarTodos()); // <- nome no plural
    ...
    public String formularioEditarUsuario(@PathVariable Long id, Model model) {
        model.addAttribute("usuario", usuarioService.buscarPorId(id)); // Corrigido "Usuario" -> "usuario"
        return "usuario/editar"; // Corrigido removendo a barra no início
    }
